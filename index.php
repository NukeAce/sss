...
<head>
 ...
 input {display:block; height:100%; padding: 0; margin: 0; border: 0; width: 100%;}
...
<script type="text/javascript" language="javascript" >
  $(document).ready(function(){
    ...
    $('#add').click(function(){
     ...
     html += '<td> <select class="form-control"id="data4"> <option value= "058">Guarantee Trust Bank</option> <option value="044">Access Bank</option></select></td>';
